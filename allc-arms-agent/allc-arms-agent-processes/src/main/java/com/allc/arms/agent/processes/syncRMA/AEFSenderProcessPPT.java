...
public class AEFSenderProcessPPT extends FileSenderProcess {
	...
	protected void inicializar() {
		...
		try {
			...
			inFolder =  new File4690("F:/ALLC/AEF/PPT");      // Ruta de origen en el Controlador CC
			outFolder = ("/usr/local/NRS/ALCEYES/MON_POS/210/020/PPT"); // Ruta de destino en el server
