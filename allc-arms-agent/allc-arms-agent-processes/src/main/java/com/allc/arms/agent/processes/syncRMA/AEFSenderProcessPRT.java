...
public class AEFSenderProcessPRT extends FileSenderProcess {

	protected void inicializar() {
		log = Logger.getLogger(AEFSenderProcessPRT.class);
		log.info("INICIA PROCESO AEF_SYNC_PRT V1...");
		...
		try {
			...
			outFolder = ("/usr/local/NRS/ALCEYES/MON_POS/210/020/PRT"); // Ruta de destino en el server
