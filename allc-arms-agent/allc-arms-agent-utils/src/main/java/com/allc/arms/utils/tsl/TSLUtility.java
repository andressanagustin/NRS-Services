...
public class TSLUtility {
	private static Logger logger = Logger.getLogger(TSLUtility.class);
	/**
...
//				break;
	...
	protected static String parsearString99(List reg) throws UnsupportedEncodingException {
		...
		if(ArmsAgentConstants.Tsl.VALIDACION_AFILIADO.equals(campo1)){
    		return campos(reg, "1111110111"); 
        } else if(ArmsAgentConstants.Tsl.COMPRA_TARJETA.equals(campo1)){
    		return campos(reg, "1111011111111111111"); 
        } else if(ArmsAgentConstants.Tsl.ACTUALIZACION_CUPO.equals(campo1)){
    		return campos(reg, "1111110111"); 
        } else if(ArmsAgentConstants.Tsl.PROMOTION_DISCOUNT_DATA.equals(campo1)){
    		return campos(reg, "110000"); 
        } else if(ArmsAgentConstants.Tsl.RENOVACIONES.equals(campo1)){
    		return campos(reg, "11111"); 
        } else if(ArmsAgentConstants.Tsl.OPERADORA_CELULARES.equals(campo1)){
    		return campos(reg, "1101011111"); 
        } else if(ArmsAgentConstants.Tsl.DONACIONES.equals(campo1)){
    		return campos(reg, "1101"); 
        } else if(ArmsAgentConstants.Tsl.DESCUENTO_TRX.equals(campo1)){
    		return campos(reg, "1111"); 
        } else if(ArmsAgentConstants.Tsl.DATOS_ADICIONALES_TRX.equals(campo1)){
    		return campos(reg, "111111"); 
        } else if(ArmsAgentConstants.Tsl.PROMO_DOLAR_VIRTUAL.equals(campo1)){
    		return campos(reg, "111111"); 
        }  else if(ArmsAgentConstants.Tsl.DESCUENTO_DIAS_D.equals(campo1)){
    		return campos(reg, "11111"); 
        }  else if(ArmsAgentConstants.Tsl.DEDUCIBLES.equals(campo1)){
    		return campos(reg, "111111"); 
        }  else if(ArmsAgentConstants.Tsl.CUPON_DESC_EMPRESARIAL.equals(campo1)){
    		return campos(reg, "11111111"); 
        }  else if(ArmsAgentConstants.Tsl.NUEVA_RESERVA_SISPE.equals(campo1)){
    		return campos(reg, "11111111"); 
        }  else if(ArmsAgentConstants.Tsl.CUPON_DESC_ESPECIAL.equals(campo1)){
    		return campos(reg, "11111111"); 
        }  else if(ArmsAgentConstants.Tsl.REIMPRESION_DOC_FICAL_PDV.equals(campo1)){
    		return campos(reg, "11111110"); 
        }  else if(ArmsAgentConstants.Tsl.COMPROBANTE_EGRESO.equals(campo1)){
    		return campos(reg, "11111101"); 
        }  else if(ArmsAgentConstants.Tsl.COMPROBANTE_INGRESO.equals(campo1)){
    		return campos(reg, "11110"); 
        }  else if(ArmsAgentConstants.Tsl.VENTA_BONO_CONSULTA_CYCA.equals(campo1)){
    		return campos(reg, "1111"); 
        }  else if(ArmsAgentConstants.Tsl.ENCUESTA_TABLET.equals(campo1)){
    		return campos(reg, "1111"); 
        }  else if(ArmsAgentConstants.Tsl.AUT_SUPERV_VIA_REMOTA.equals(campo1)){
    		return campos(reg, "11111111"); 
        }  else if(ArmsAgentConstants.Tsl.BENEF_EMPRESARIAL_CONTROLADO.equals(campo1)){
    		return campos(reg, "11111"); 
        }  else if(ArmsAgentConstants.Tsl.NOTA_CREDITO_ELEC.equals(campo1)){
    		return campos(reg, "11111101100"); 
        }  else if(ArmsAgentConstants.Tsl.FACTURA_ELEC.equals(campo1)){
    		return campos(reg, "1111000"); 
        }  else if(ArmsAgentConstants.Tsl.LLAMADO_ASISTENTE.equals(campo1)){
    		return campos(reg, "1111101"); 
        }  else if(ArmsAgentConstants.Tsl.SUPERV_AUT_CANTIDAD.equals(campo1)){
    		return campos(reg, "111"); 
        }  else if(ArmsAgentConstants.Tsl.TARJETA_CREDITO.equals(campo1)){
    		return campos(reg, "1111100110111011110"); 
        }  else if(ArmsAgentConstants.Tsl.CONTROL_FUNDA.equals(campo1)){
    		return campos(reg, "111111"); 
        }  else if(ArmsAgentConstants.Tsl.TOTALES_TRX.equals(campo1)){
    		return campos(reg, "111111111111111"); 
        }  else if(ArmsAgentConstants.Tsl.SEGURO_GARANT_TOTAL_COMPRA_SEG.equals(campo1)){
    		return campos(reg, "11001111110110"); 
        }  else if(ArmsAgentConstants.Tsl.CONTRATO_GARANT_TOTAL.equals(campo1)){
    		return campos(reg, "11111"); 
        }  else if(ArmsAgentConstants.Tsl.INGRESO_VOUCHER_CERRADO_EFEC.equals(campo1)){
    		return campos(reg, "1111111"); 
        }  else if(ArmsAgentConstants.Tsl.BASE_DESC_LOYALTY_ERRADA.equals(campo1)){
    		return campos(reg, "111111"); 
        }  else if(ArmsAgentConstants.Tsl.PRODUCTO_DIA.equals(campo1)){
    		return campos(reg, "1111"); 
        }  else if(ArmsAgentConstants.Tsl.REG_CAMBIO_DATO_FACTURA.equals(campo1)){
    		return campos(reg, "110111"); 
        }  else if(ArmsAgentConstants.Tsl.CRED_PROPIO_FACTURACION.equals(campo1)){
    		return campos(reg, "1111111110010"); 
        }  else if(ArmsAgentConstants.Tsl.NOTA_CRED_VALE_ELEC.equals(campo1)){
    		return campos(reg, "1111110110000100"); 
        }  else if(ArmsAgentConstants.Tsl.REG_GENERICO_VENDEDOR.equals(campo1)){
    		return campos(reg, "11110"); 
        }  else if(ArmsAgentConstants.Tsl.VALE_CAJA_CAMB_EFEC.equals(campo1)){
    		return campos(reg, "1111111"); 
        } else if(ArmsAgentConstants.Tsl.REPO_CAJA_CHICA_EFEC.equals(campo1)){
    		return campos(reg, "1111111"); 
        } else if(ArmsAgentConstants.Tsl.CASHBACK_ALFALFA_RECURRENCIA.equals(campo1)){
    		return campos(reg, "1110"); 
        } else if(ArmsAgentConstants.Tsl.ACUM_PROMO_ALBUM_VIRTUAL.equals(campo1)){
    		return campos(reg, "111001"); 
        } else if(ArmsAgentConstants.Tsl.DATOS_ADIC_TRX2.equals(campo1)){
    		return campos(reg, "111000"); 
        } else if(ArmsAgentConstants.Tsl.ACUM_CASHBACK_CABECERA.equals(campo1)){
    		return campos(reg, "1110100"); 
        } else if(ArmsAgentConstants.Tsl.ACUM_CASHBACK_DETALLE.equals(campo1)){
    		return campos(reg, "110001"); 
        } else if(ArmsAgentConstants.Tsl.PAGO_DIVIDENDOS_ACCION_EFECT.equals(campo1)){
    		return campos(reg, "1101111"); 
        } else if(ArmsAgentConstants.Tsl.TRANS_DELIVERY_PLATF_WEB.equals(campo1)){
    		return campos(reg, "1100"); 
        } else if(ArmsAgentConstants.Tsl.DESC_DIRECTO_PROD.equals(campo1)){
    		return campos(reg, "1111"); 
        } else if(ArmsAgentConstants.Tsl.PROMO_LOYALTY.equals(campo1)){
    		return campos(reg, "11111"); 
        } else if(ArmsAgentConstants.Tsl.DESC_ART_LOYALTY.equals(campo1)){
    		return campos(reg, "1111"); 
        } else if(ArmsAgentConstants.Tsl.DESC_ART_PROMO_LOYALTY.equals(campo1)){
    		return campos(reg, "11101"); 
        } else if(ArmsAgentConstants.Tsl.DESC_EMP_DATA.equals(campo1)){
