...
public class MultipleTSLReaderProcess extends AbstractProcess {
    ...
    private Logger log = Logger.getLogger(MultipleTSLReaderProcess.class);
    ...
    private final String path = "/home/ArchivosLGs/1";
    private final String pathProcesados = "/home/ArchivosLGs/procesados/1";
