...
public class TSLSenderExtra13Process extends TSLSenderProcess {
	...
	protected void inicializar() {
		...
		try {
			...
			inFolder = new File(properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator +properties.getObject("tslSender.in.folder.path") + File.separator + "extra13" + File.separator);
			outFolder = properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator + "extra13" ;
			inFolder.mkdirs();
