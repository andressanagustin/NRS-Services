...
public class TSLSenderExtra2Process extends TSLSenderProcess {
	...
	protected void inicializar() {
		...
		try {
			...
			inFolder = new File(properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator +properties.getObject("tslSender.in.folder.path") + File.separator + "extra2" + File.separator);
			outFolder = properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator + "extra2" ;
			inFolder.mkdirs();
