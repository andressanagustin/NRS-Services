...
public class TSLSenderExtra51Process extends TSLSenderProcess {
	...
	protected void inicializar() {
		...
		try {
			...
			inFolder = new File(properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator +properties.getObject("tslSender.in.folder.path") + File.separator + "extra51" + File.separator);
			outFolder = properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator + "extra51" ;
			inFolder.mkdirs();
