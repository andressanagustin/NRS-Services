...
/**
 * com.allc.arms.server.processes.tsl.sender.TSLSenderExtraProcess,com.allc.arms.server.processes.tsl.sender.TSLSenderExtra1Process
 */
public class TSLSenderExtraProcess extends TSLSenderProcess {
	...
	protected void inicializar() {
		...
		try {
			...
			inFolder = new File(properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator +properties.getObject("tslSender.in.folder.path") + File.separator + "extra" + File.separator);
			outFolder = properties.getObject("TSL.defaultLocalRepositoryToStore") + File.separator + "extra" ;
			inFolder.mkdirs();
