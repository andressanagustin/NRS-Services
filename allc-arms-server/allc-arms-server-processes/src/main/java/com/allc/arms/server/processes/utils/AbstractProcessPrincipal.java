 ...
 */
package com.allc.arms.server.processes.utils;
 ...
 * @author Tyrone Lopez
 */
public abstract class AbstractProcessPrincipal extends AbstractProcess {
    
    private static final Logger LOG = Logger.getLogger(AbstractProcessPrincipal.class.getName());
