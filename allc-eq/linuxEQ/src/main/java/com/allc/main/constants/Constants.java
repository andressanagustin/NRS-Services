...
public class Constants {
	...
	public static class Componente{
		...
		/**Fecha de la version**/
		public static final String FECHA_VERSION = "08/02/2022";
		/**Ruta donde residira la aplicacion**/
		public static final String NOMBRE_LOG = "log4jLinuxEQ.properties";
		/**Nombre del programa**/
		public static final String WIN_EQ_JAR = "LinuxEQ.jar";
