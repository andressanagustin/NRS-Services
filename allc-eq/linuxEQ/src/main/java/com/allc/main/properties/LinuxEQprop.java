...
public class LinuxEQprop {
	static Logger log = Logger.getLogger(LinuxEQprop.class);
	/** Atributo para singleton.*/
	private static LinuxEQprop instancia;
	/** Atributo para hacer la conexion con el archivo de propiedades **/
	private static Properties props;
	
	private String ruta = "";
	private String PropFileName = "LinuxEQ.properties";
	 ...
	 * @return
	 */
	public static LinuxEQprop getInstancia(){
		if(instancia == null){
			instancia = new LinuxEQprop();
		}
		return instancia;
	} 
